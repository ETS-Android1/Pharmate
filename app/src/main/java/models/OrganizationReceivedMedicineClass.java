...
public class OrganizationReceivedMedicineClass {
    private String nameOfMedicine, barcodeNumber, donatedBy, lastDonationTo, expirationdate;
    private Integer quantity;

    public OrganizationReceivedMedicineClass() {
    }

    public OrganizationReceivedMedicineClass(String nameOfMedicine, String barcodeNumber, String donatedBy, String lastDonationTo, String expirationdate, Integer quantity) {
