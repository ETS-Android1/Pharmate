...
public class OrganizationDonatedMedicineClass {
    private String nameOfMedicine, barcodeNumber, donatedBy, lastDonationTo, expirationdate;
    private Integer quantity;

    public OrganizationDonatedMedicineClass() {
    }

    public OrganizationDonatedMedicineClass(String nameOfMedicine, String barcodeNumber, String donatedBy, String lastDonationTo, String expirationdate, Integer quantity) {
