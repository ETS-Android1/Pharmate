...
public class UserDonatedMedicineClass {
    private String nameOfMedicine, barcodeNumber, donatedBy, lastDonationTo, expirationdate;
    private Integer quantity;

    public UserDonatedMedicineClass() {
    }

    public UserDonatedMedicineClass(String nameOfMedicine, String barcodeNumber, String donatedBy, String lastDonationTo, String expirationdate, Integer quantity) {
